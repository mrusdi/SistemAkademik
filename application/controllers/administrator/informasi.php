...
class Informasi extends CI_Controller {
    ...
    public function _rules()
    {
        ...
        $this->form_validation->set_rules('judul_informasi','judul_informasi','required',['required'=> 'Judul wajib di isi!']);
        $this->form_validation->set_rules('isi_informasi','isi_informasi','required',['required'=> 'isi_informasi wajib di isi!']);  
    ...
    public function delete($id)
    {
        ...
        $this->session->set_flashdata('pesan','<div class="alert alert-danger alert-dismissible fade show" role="alert">
            Data Informasi erhasil Dihapus!
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>');
