...
class Dosen extends CI_Controller {
    ...
    {
        //mengambil nama dosen dari tabel prodi
    ...
    {
        $this->form_validation->set_rules('nidn','nidn','required',['required'=> 'NIDN wajib di isi!']);
        $this->form_validation->set_rules('nama_dosen','nama_dosen','required',['required'=> 'Nama Dosen wajib di isi!']);
        ...
        $this->form_validation->set_rules('telepon','telepon','required',['required'=> 'No Telepon wajib di isi!']);
        
        // $this->form_validation->set_rules('photo','photo','required',['required'=> 'Photo wajib di isi!']);
