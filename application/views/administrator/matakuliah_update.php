    ...
    <?php foreach($matakuliah as $mk)  : ?>
        <form method="post" action="<?php echo base_url('administrator/matakuliah/update_aksi') ?>">
            ...
            <div class ="form-group">
                ...
                <input type="hidden" name="kode_matakuliah" class ="form-control" value="<?php echo base_url($mk->kode_matakuliah) ?>" >
                <input type="text" name="nama_matakuliah" class ="form-control" value="<?php echo base_url($mk->nama_matakuliah) ?>" >
