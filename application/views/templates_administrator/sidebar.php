    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('administrator/dashboard') ?>">
                ...
                <div class="sidebar-brand-text mx-0">Sistem Akademik </div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url('administrator/matakuliah') ?>">Mata Kulliah</a>
                        ...
                        <a class="collapse-item" href="#">Cetak Transkip</a>
                        <a class="collapse-item" href="<?php echo base_url('administrator/dosen') ?>">Dosen</a>                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                src=" <?php echo base_url('assets/img/bima.png')?>">
                            </a>
